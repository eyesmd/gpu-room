...
int main() {
    ...
    // My GPU complies to the 4.1 version
    ...
    glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE); // Removes (the few in 3.2+) deprecated features, needed for Mac to properly build
